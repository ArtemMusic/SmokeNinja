                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$user->id}}</td>
                                            <td>{{$user->name}}</td>
                                            <td><a href="{{route('admin.user.show', $user->id)}}"><i class="fa-thin fas fa-eye"></i></a></td>
                                            <td><a href="{{route('admin.user.edit', $user->id)}}"><i class="fa-thin fas fa-pen text-success"></i></a></td>
                                            <td>
